...
//   * @param interpolator {@link com.ogaclejapan.smarttablayout.SmartTabIndicationInterpolator}
  ...
  protected TextView createDefaultTabView(CharSequence title) {
    //SwissNormalFont textView;
    TextView textView;

//    if(Constants1.LANGUAGE.equalsIgnoreCase(Constants1.ENGLISH) || Constants1.LANGUAGE.equalsIgnoreCase(Constants1.ROMAN))
//    textView= new SwissNormalFont(getContext());
...
//      textView.setAllCaps(tabViewTextAllCaps);
    ...
    textView.setPadding(
        ...
        tabViewTextHorizontalPadding, 30);
